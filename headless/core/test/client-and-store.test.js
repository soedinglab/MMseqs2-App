...
test('nothing is submitted when validation fails', async () => {
    ...
    const rejections = [
        ...
        [() => client.submitFoldseekSearch({ query: QUERY, databases: ['pdb100'], taxFilter: 'human' }), /no taxon matches|matches no scientific name/],
        [() => client.submitFoldseekSearch({ query: QUERY, databases: ['pdb100'], taxFilter: '9606;10090' }), /invalid taxon filter/],
