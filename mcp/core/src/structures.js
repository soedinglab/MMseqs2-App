...
import { structureRemarkLine } from '../../../frontend/lib/structureRemark.js';
...
/** Describe a loaded structure without echoing its coordinate text. */
export function describeLoadedStructure(loaded) {
    return {
        id: loaded.id, source: loaded.source, name: loaded.name,
...
export async function loadAccession(id, {
...
export async function loadAccessions(ids, opts = {}) {
