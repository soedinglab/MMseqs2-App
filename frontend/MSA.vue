...
import { entryChainMap } from './lib/alignmentColumns.js';
...
export default {
    ...
    beforeMount() {
        ...
        for (let entry of this.entries) {
            ...
            const map = entryChainMap(entry.aa, entry.suffix)

            entry.offsets = map.offsets
            entry.chains = map.chains
            entry.resns = map.resns
