  ...
  : new VueRouter({
      ...
      routes: [
        ...
        { name: "folddisco", path: "/folddisco", component: FoldDiscoSearch },
        {
          ...
          component: ResultFoldMason,
        },
        {
          name: "folddiscoresult",
          path: "/result/folddisco/:ticket",
          component: ResultFoldDisco,
        },
        ...
        },
        {
          name: "preferences",
          path: "/preferences",
          component: () => (__ELECTRON__ ? import("./Preferences.vue") : null),
        },
      ],
  ...
  install(Vue, options) {
    ...
    if (__ELECTRON__) {
      ...
      Vue.prototype.handleTitleBarDoubleClick =
        remote.app.handleTitleBarDoubleClick;
